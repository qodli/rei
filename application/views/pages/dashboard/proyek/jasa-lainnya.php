                                ...
                                <tr>
                                    ...
                                    <td>
                                         <select name="" class="form-control" onchange="location = this.options[this.selectedIndex].value;">
                                            ...
                                            <option value="<?php echo base_url('proyek'); ?>/<?php echo $this->uri->segment(2) ?>?type=edit&id=<?php echo $vdata['id_proyek_jasa'] ?>&ip=<?php echo $vdata['id_perusahaan'] ?>&m=<?php echo base64_encode($this->session->userdata("email")) ?>">Edit</option>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php if ($edit == 0): ?>
                                        ...
                                        <?php else: ?>
                                            <textarea name="deskripsi_jasa" rows="7" class="form-control" required><?php echo $getEdit->deskripsi_jasa ?></textarea>
                                    <?php endif ?>
