                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown profile">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            <span class="meta">
                                <span class="avatar">
                                    <?php $cekava = $this->db->get_where('user', array('id' => $this->session->userdata('id')))?>
                                    <?php if ($cekava->first_row()->avatar == NULL): ?>
                                        <img src="<?php echo base_url() ?>assets/image/avatar/avatar.png" class="img-circle" alt="" />
                                    <?php else: ?>
                                        <img src="<?php echo base_url() ?>avatar/<?php echo $cekava->first_row()->avatar ?>" class="img-circle" alt="" />
                                    <?php endif ?>
