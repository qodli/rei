...
class Register_model extends CI_Model {
	...
	public function Register_1(){
		...
		$inputDB = $this->db->insert('perusahaan', array(
			...
			'alamat_perusahaan' => implode('|', $this->input->post('alamat_perusahaan')),
			'rt_rw' => implode('|', $this->input->post('rt_rw')),
			'kelurahan_desa' => implode('|', $this->input->post('kelurahan_desa')),
			'kecamatan' => implode('|', $this->input->post('kecamatan')),
			'kota_kabupaten' => implode('|', $this->input->post('kota_kabupaten')),
			'kodepos' => implode('|', $this->input->post('kodepos')),
			'rei_provinsi' => implode('|', $this->input->post('rei_provinsi')),
			'nama_rei_daerah' => implode('|', $this->input->post('nama_rei_daerah')),
			'email_perusahaan' => implode('|', $this->input->post('email_perusahaan')),
			'telp_perusahaan' =>implode('|',  $this->input->post('telp_perusahaan')),
			'fax_perusahaan' => implode('|', $this->input->post('fax_perusahaan')),
			'npwp_perusahaan' => implode('|', $this->input->post('npwp_perusahaan')),
			'website_perusahaan' => implode('|', $this->input->post('website_perusahaan')),
			'jenis_bidang_usaha_perusahaan' => implode('|', $this->input->post('jenis_bidang_usaha_perusahaan')),
		));
		...
		$this->db->update('user', array(
			...
			'company' => implode('|', $this->input->post('nama_perusahaan')),
		));
