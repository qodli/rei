                ...
                <form class="panel panel-default" action="" method="post" autocomplete="off" data-parsley-validate>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="control-label">Nama Izin Prinsip <span class="text-danger">*</span></label>
                                    <?php if ($edit == 0): ?>
                                ...
                                <div class="col-sm-6">
                                    <label class="control-label">No Izin Prinsip <span class="text-danger">*</span></label>
                                    <?php if ($edit == 0): ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="control-label">Tanggal Izin Prinsip <span class="text-danger">*</span></label>
                                    <?php if ($edit == 0): ?>
                                ...
                                <div class="col-sm-6">
                                    <label class="control-label">Pemberi Izin Prinsip <span class="text-danger">*</span></label>
                                    <?php if ($edit == 0): ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="control-label">Izin Untuk Proyek <span class="text-danger">*</span></label>
