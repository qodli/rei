            ...
            <div class="col-lg-9">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="profile">
                        <!-- form profile -->
                        <form class="panel form-horizontal form-bordered" name="form-profile" method="post" autocomplete="off">
                            <div class="panel-body pt0 pb0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control" value="<?php echo $getProfile->first_row()->company ?>" readonly>
                                    </div>
                                </div>
