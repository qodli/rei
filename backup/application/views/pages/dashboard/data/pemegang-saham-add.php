                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php if ($edit == 0): ?>
                                        <input name="nama_pemegang_saham" type="text" class="form-control">
                                    <?php else: ?>
                                        <input name="nama_pemegang_saham" type="text" class="form-control" value="<?php echo $getEdit->nama_pemegang_saham ?>">
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
