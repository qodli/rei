                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <?php if ($edit == 0): ?>
                                        <input name="bid_usaha_cabang" type="text" class="form-control" required>
                                    <?php else: ?>
                                        <input name="bid_usaha_cabang" type="text" class="form-control" required value="<?php echo $getEdit->bid_usaha_cabang ?>">
                                    <?php endif ?>
                                </div>
                            </div>
                        </div>
